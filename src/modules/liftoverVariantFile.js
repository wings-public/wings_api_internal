...
(async function () {
    try {
        ...
        var scriptInput = argParser.input;
        ...
        // /home/nsattanathan/variant_discovery/datafiles2/hg19
        // /home/nsattanathan/variant_discovery/datafiles2/hg38
        ...
        try {
            //console.log(`Data to copy from ${scriptInput} copied to ${hostLoc}`);
            await fs.promises.copyFile(scriptInput, hostLoc);
            //console.log(`Data from ${scriptInput} copied to ${hostLoc}`);
        } catch(err) {
            console.log("Error copying file");
            console.log(err);
        }

        /*console.log("Logging and checking the files ------------");
        console.log(`inputFile:${inputFile}`);
        console.log(`outputFile:${outputFile}`);
        console.log(`chainFile:${chainFile}`);
        console.log(`fastaFile:${fastaFile}`);
        console.log(`rejectFileTmp:${rejectFileTmp}`);*/
        ...
        try {
            ...
            if ( liftoverDocker == "false" ) {
                ...
                //console.log("Executing liftover command:");
                //console.log(cmd);
            } else {
        ...
        spawn.exec(cmd, async(err, stdout, stderr) => {
            ...
            if (err) {
                ...
                //console.log("OK ++++++ liftover performed");
                //console.log(stdout);
                // read the file
                ...
                try {
                    ...
                    //console.log("Lifted Data is available at location :"+hostOpFile);
