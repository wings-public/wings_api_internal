...
(async function () {
    ...
    try {
        var val = await parseFile(inputFile,createLog,annoCollection,archiveAnnoCollObj,annoType);
...
async function parseFile(file,createLog,annoCollection,archiveAnnoCollObj,annoType) {
    var reFile = /\.gz/g;
    var rd;
    ...
    rd.on('line', function (line) {
        ...
        // upsert is not set for versioning collection
